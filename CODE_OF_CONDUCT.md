...
When an incident does occur, it is important to report it promptly. To report a possible violation, contact the project maintainer and community moderator, **Manfred J Ekblad**, privately via GitHub: [https://github.com/manfredjekblad](https://github.com/manfredjekblad). Do not use public issues for sensitive Code of Conduct reports.
